...
public class Pawn extends ChessPiece {
    ...
    public Coordinates[]getValidMoves() {
        ...
        Coordinates forwardOne = getCoordinates().withOffset(0, calcYWithDirFactor(1));
    ...
    @Override
    public void setCoordinates(Coordinates coordinates) { // Note this trick used to do a check with composition
